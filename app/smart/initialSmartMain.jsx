...
export const mainPoolAddress = '0x86319Fa4e3154f2Fd0C3F86C7dE522Ee44a60D0c'
...
const getNftContract = () => {
    ...
    const address_nft = '0xd9D3aBcf9234925751dA1139Af22983d01C60c2d';
...
const getNoNameNftContract = () => {
  const provider = new ethers.providers.Web3Provider(window.ethereum);
  const signer = provider.getSigner()
  const address_nft= '0xF36beD7bF584D3192d09b09F968CdF48cE6652B3';
  const abi_nft = [
	  {
		  "inputs": [
			  {
...
const getUSDContract = () => {
	const provider = new ethers.providers.Web3Provider(window.ethereum);
    const signer = provider.getSigner()
	const address_usd= '0x4300000000000000000000000000000000000003';
