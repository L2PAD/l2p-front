...
export const mainPoolAddress = '0x629f1dA4fE0c62abc2a6ee31Eea44F6343552c91'
...
const getNoNameNftContract = () => {
  const provider = new ethers.providers.Web3Provider(window.ethereum);
  const signer = provider.getSigner()
  const address_nft= '0xdE04D3ec5e61f9b3bA8D38752FbC6B49C0CB90aA';
  const abi_nft = [
	  {
		  "inputs": [
			  {
...
const getUSDContract = () => {
	const provider = new ethers.providers.Web3Provider(window.ethereum);
    const signer = provider.getSigner()
	const address_usd= '0x4200000000000000000000000000000000000022';
