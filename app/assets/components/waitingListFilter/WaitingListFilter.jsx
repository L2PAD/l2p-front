...
import { closeModalWithoutBlock, toggleModalWithoutBlock } from '../../../store/slices/modalsSlice'
...
export default function WaitingListFilter({handleFilterChange}) {
    const [filters,setFilters] = useState(filtersInitialState)
    const isVisible = useSelector((state) => state.modals.waitingListFilter.state)
  ...
  return (
    ...
    <div className={styles.mobileBody}>
       <button 
        onClick={() => dispatch(toggleModalWithoutBlock('waitingListFilter'))}
